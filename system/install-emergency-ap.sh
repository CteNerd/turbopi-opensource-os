...
echo "  SSID: TurboPi-Emergency-<MAC>  (replace <MAC> with last 4 chars of wlan0 MAC)"
echo "  Password: TurboPi-7f9d2b1c4e5a  ⚠️  CHANGE THIS NOW!"
echo "  Robot IP: 192.168.50.1"
echo "  Web UI: http://192.168.50.1:8080"
echo ""
echo "⚠️  IMPORTANT: Configuration Required Before Use ⚠️"
echo "The AP will NOT work until you customize the configuration:"
echo ""
